...
export default {
    ...
    methods: {
        ...
        */
            ...
            if(this.rate_state === 1){
              Swal.fire('Sorry !', 'You have already rated this tutorial','warning');
                ...
                .then((res) => {
                    ...
                    this.getAuthRating(this.users.id, this.tutorial.id)
                    this.getPackage();
                }).catch((error) => {
                    Swal.fire("Failed :" + error.response.data.error,'warning');
                }).finally(() => {
        ...
        getAuthRating(user_id, tito_id){
            this.rate_state = '';
            Con.getAuthUserTitoRate(user_id, tito_id)
            .then((res) => {
